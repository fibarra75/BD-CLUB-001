...
PROCEDURE PRC_CREAR_SOCIO_EXT(P_RUT IN NUMBER, P_DV IN VARCHAR2, P_NOMBRES IN NVARCHAR2, P_APATERNO IN NVARCHAR2, P_AMATERNO IN NVARCHAR2, P_SEXO IN varchar2, P_FENAC IN DATE, P_CORREO IN NVARCHAR2, P_NROCELULAR IN NUMBER);
...
PROCEDURE PRC_CREAR_SOCIO_EXT(P_RUT IN NUMBER, P_DV IN VARCHAR2, P_NOMBRES IN NVARCHAR2, P_APATERNO IN NVARCHAR2, P_AMATERNO IN NVARCHAR2, P_SEXO IN varchar2, P_FENAC IN DATE, P_CORREO IN NVARCHAR2, P_NROCELULAR IN NUMBER) IS
V_CORR NUMBER;
  BEGIN
    --SELECT MAX(IDSOCIO) + 1 INTO V_CORR FROM SOCIO;
    SELECT SQ_SOCIO.NEXTVAL INTO V_CORR FROM DUAL;
