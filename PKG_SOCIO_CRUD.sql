...
PROCEDURE PRC_CREAR_SOCIO_EXT(P_RUT IN NUMBER, P_DV IN VARCHAR2, P_NOMBRES IN NVARCHAR2, P_APATERNO IN NVARCHAR2, P_AMATERNO IN NVARCHAR2, P_SEXO IN varchar2, P_FENAC IN DATE, P_CORREO IN NVARCHAR2, P_NROCELULAR IN NUMBER, P_TIPOSOCIO IN NUMBER, P_ERRCOD OUT NUMBER, P_ERRMSG OUT VARCHAR2);

PROCEDURE PRC_MODIFICAR_SOCIO(P_RUT IN NUMBER, P_NOMBRES IN NVARCHAR2, P_APATERNO IN NVARCHAR2, P_AMATERNO IN NVARCHAR2, P_SEXO IN varchar2, P_FENAC IN DATE, P_CORREO IN NVARCHAR2, P_NROCELULAR IN NUMBER, P_TIPOSOCIO IN NUMBER, P_IDESTADO IN NUMBER);
...
PROCEDURE PRC_CREAR_SOCIO(P_RUT IN NUMBER, P_DV IN VARCHAR2, P_NOMBRES IN NVARCHAR2, P_APATERNO IN NVARCHAR2, P_AMATERNO IN NVARCHAR2
                        , P_SEXO IN varchar2, P_ERRCOD OUT NUMBER, P_ERRMSG OUT VARCHAR2) IS
  V_CORR NUMBER;
  V_CONT NUMBER;
  BEGIN
    P_ERRCOD:=0;
...
PROCEDURE PRC_CREAR_SOCIO_EXT(P_RUT IN NUMBER, P_DV IN VARCHAR2, P_NOMBRES IN NVARCHAR2, P_APATERNO IN NVARCHAR2
        , P_AMATERNO IN NVARCHAR2, P_SEXO IN varchar2, P_FENAC IN DATE, P_CORREO IN NVARCHAR2, P_NROCELULAR IN NUMBER
        , P_TIPOSOCIO IN NUMBER, P_ERRCOD OUT NUMBER, P_ERRMSG OUT VARCHAR2) IS
		--Se agregaron dos variables de salida.
V_CORR NUMBER;
V_CONT NUMBER;
  BEGIN
    P_ERRCOD:=0;
...
PROCEDURE PRC_MODIFICAR_SOCIO(P_RUT IN NUMBER, P_NOMBRES IN NVARCHAR2, P_APATERNO IN NVARCHAR2, P_AMATERNO IN NVARCHAR2, P_SEXO IN varchar2, P_FENAC IN DATE, P_CORREO IN NVARCHAR2, P_NROCELULAR IN NUMBER, P_TIPOSOCIO IN NUMBER, P_IDESTADO IN NUMBER) IS
BEGIN
    UPDATE SOCIO
    SET 
    NOMBRES = P_NOMBRES,
